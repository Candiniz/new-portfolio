...
export default function AboutMe() {
    return (
        <main className={`${ibmPlexMono.className} xl:w-120 flex flex-wrap-reverse justify-center items-center gap-10 md:gap-20 pt-10 pb-36 text-lg xl:flex-nowrap xl:justify-between`}>
