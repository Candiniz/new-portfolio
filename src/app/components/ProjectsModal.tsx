            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className={`${roboto.className} fixed inset-0 left-1/2 transform -translate-x-1/2 w-[80%] bg-[#25252565] rounded-t-lg shadow-lg z-50 h-[100dvh] max-h-[100dvh] flex flex-col`}
                    >
                        {/* Título no topo */}
