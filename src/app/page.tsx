  ...
  const projects = [
    {
      slug: 'disordle',
      name: 'Disordle',
      projectLink: 'https://disordle.vercel.app',
      repositoryLink: 'https://github.com/Candiniz/disordle',
      linkedIn: 'https://www.linkedin.com/feed/update/urn:li:activity:7312852213691826177/',
      icons: (
        <>
          <FaReact />
          <FaJs />
      ...
      image: {
        url: 'https://i.imgur.com/VEkHZWi.png',
        alt: "Disordle nasceu da minha paixão por jogos de lógica com palavras e do desejo de criar algo próprio dentro desse universo. Inspirado em jogos como Wordle e Termo, decidi construir minha própria versão — com mecânicas familiares, mas também com funcionalidades únicas que elevam a experiência do jogador.\n\n Assim como em outros projetos autorais, optei pela abordagem de clonagem por observação, um método onde me baseio exclusivamente na minha vivência como jogador, sem consultar o código- fonte dos jogos originais.Isso me força a decifrar e recriar cada lógica por trás da experiência, utilizando apenas a percepção das regras, da interação e da dinâmica visual.\n\n O Disordle permite partidas ilimitadas, personalização do número de letras e exibição do significado da palavra final — um diferencial que estimula não apenas o raciocínio, mas também o vocabulário dos jogadores.\n\n Durante o desenvolvimento, um dos maiores desafios técnicos foi a construção de um banco de palavras confiável.Para garantir variedade e precisão, implementei múltiplas estratégias: \n - Integração com a API do Dicionário Aberto para validação lexical; \n - Web Scraping com Node.js no Dicio para expandir o vocabulário; \n - Filtros personalizados para restringir o jogo a verbos e substantivos comuns, garantindo coerência e jogabilidade justa.\n\n Toda a lógica de verificação das tentativas foi construída do zero em React.js, cuidando para que o feedback visual das letras fosse claro, responsivo e intuitivo.A arquitetura do jogo prioriza performance, clareza e facilidade de expansão — atributos fundamentais para futuros incrementos.\n\n Atualmente, o projeto já está disponível em produção, mas continua em evolução.Meu próximo objetivo é adicionar sistema de autenticação, rankings e conquistas, criando uma camada competitiva e social para os jogadores mais engajados.\n\n O código - fonte está disponível no GitHub e o jogo pode ser jogado online por qualquer navegador moderno.O Disordle representa minha constante busca por unir aprendizado técnico, criatividade e diversão em projetos que desafiem tanto o usuário quanto o desenvolvedor por trás da tela.",
  date: '04/12/2024'
}
    },
{
